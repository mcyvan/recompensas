...
$producciones=obtenerTablaPlan($planta=2);//1=Este, 2=Sur
?>
<!doctype html>
<html lang="es">
  <!--begin::Head-->
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Captura Plan Produccion Sur</h3></div>
              <div class="col-sm-6">
            ...
            <div class="row justify-content-center align-items-center">            
                <div class="card card-info card-outline mb-4 col-sm-6">
                    ...
                    <div class="card-header">
                        <div class="card-title"><b>Captura Plan Produccion Sur</b></div>                        
                    </div>
                    <!--end::Header-->
                    <!--begin::Form-->
                    <form class="needs-validation" novalidate="" action="../controller/controller_registrar_plan_captura_sur.php" method="post">                      
                        <!--begin::Body-->
                        <div class="card-body">
                        <!--begin::Row-->
                          <div class="row g-3">
                          ...
                          <div class="card-footer mt-2">
                            <button class="btn btn-info" type="submit">Registrar Dia</button>
        ...
        <!--end::App Content-->
          ...
          <div class="container-fluid">           
            ...
            <div class="row justify-content-center align-items-center">            
              ...
              <table id="tablaCapturaPlanSur" class="table table-hover" style="width:100%">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    ...
                    <tr>                      
                      ...
                      <td><a href="../controller/controller_eliminar_plan_produccion_sur.php?id_plan_produccion=<?php echo $produccion['id_plan_produccion'];?>" class="btn btn-outline-danger m-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
                        <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5m-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5M4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06m6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528M8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5"/>
                        </svg></a></a><a href="../configuracion/editar_plan_sur.php?id_plan_produccion=<?php echo $produccion['id_plan_produccion'];?>" class="btn btn-outline-warning "><i class="bi bi-pencil-fill"></i></a>
                      </td>
                    </tr>
                    <?php
                    }
  ...
  var table = document.getElementById('tablaCapturaSur');
