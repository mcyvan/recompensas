                ...
                <!--begin::Container-->
                    <div class="container-fluid">
                        <!--begin::Row-->
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="mb-0">Captura Plan Produccion Sur</h3>
                                </div>                                
                            </div>
                        <!--end::Row-->
                    </div>
                                    ...
                                    <!--begin::Header-->
                                        <div class="card-header">
                                            <div class="card-title">
                                                <b>Captura Plan Produccion Sur - <?php echo $id_plan_produccion ?></b>
                                            </div>                        
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Form-->
                                        <form class="needs-validation" novalidate="" action="../controller/controller_actualizar_plan_captura_sur.php" method="post">                      
                                            <!--begin::Body-->
                                            <div class="card-body">
                                                <!--begin::Row-->
                                                <div class="row g-3">
                                        ...
                                        <div class="card-footer mt-2">
                                            <button class="btn btn-info" type="submit">Actualizar Dia</button>                            
                                            <a href="../configuracion/captura_plan_sur.php" class="btn btn-secondary">Regresar</a>
                                        </div><!--end::Footer-->
                                    </form><!--end::Form-->
                                </div>
                            </div><!-- /.row (main row) -->                    
